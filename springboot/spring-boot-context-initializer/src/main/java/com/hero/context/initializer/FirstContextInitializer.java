 ...
 */
@Order(1)
public class FirstContextInitializer implements ApplicationContextInitializer {
    @Override
    public void initialize(ConfigurableApplicationContext applicationContext) {
        ...
        MapPropertySource mapPropertySource = new MapPropertySource("firstInitializer", propertyMap);
